...
{
    public class clseBookingsCollection
    {
        private List<clseBookings> mAllBookings = new List<clseBookings>();

        public clseBookingsCollection()// public contructor to the class
        ...
        public List<clseBookings> AllBookings
