<%@ Page Title="" Language="C#" MasterPageFile="~/ClothingProject2.master" AutoEventWireup="true" CodeFile="WomensTopsandShirts.aspx.cs" Inherits="WomensTopsandShirts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> No of products in your shopping cart:&nbsp;&nbsp;&nbsp;
   ...
   <ItemTemplate>
            <table border="1" class="auto-style21">
                ...
                <tr>
                    <td class="auto-style25">
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("ProductImage") %>' CommandArgument='<%#  Eval("Productid")%>' CommandName="addtocart"/>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style25">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CartConnectionString %>" SelectCommand="SELECT Productid, Description, Price, ProductType, ProductImage FROM Product WHERE (ProductType = 'WomensTop')"></asp:SqlDataSource>
</asp:Content>
